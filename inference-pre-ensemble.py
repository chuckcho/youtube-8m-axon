...
def inference(reader, train_dir, data_pattern, out_file_location, batch_size, top_k):
  with tf.Session() as sess:
    video_id_batch, video_batch, _, num_frames_batch = get_input_data_tensors(reader, data_pattern, batch_size)
...
def main(unused_argv):
  ...
  print ( '-----> build_model successuflly done \n\n\n\n\n\n')
  
  saver = tf.train.Saver(max_to_keep=0, keep_checkpoint_every_n_hours=10000000000)
