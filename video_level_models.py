  ...
  def create_model(self,
    ...
    if gating_probabilities:
        if gating_input == 'prob':
            ...
            gates = tf.matmul(final_probabilities, gating_weights)
        else:
            gating_weights = tf.get_variable("gating_prob_weights",
        ...
        if remove_diag:
            ...
            gates = gates - tf.multiply(diagonals,final_probabilities)
        ...
        final_probabilities = tf.multiply(final_probabilities,gates)
