...
if __name__ == "__main__":
    ...
    if verbose:
        print "[Info] Reading sub/over-sampling information..."
    ...
    for group_count, record_group in enumerate(grouper(records, n=num_record)):
        if verbose:
            print "[Info] Reading record group ({}/{})...".format(
	...
	min_count_labels = set()
        ...
        for record in record_group:
            ...
            if os.path.isfile(new_record_file) and not overwrite:
                print "[Info] new_record_file={} already exists. skipping...".format(new_record_file)
                continue

            if verbose:
                print "[Info] Writing new tfrecord={}...".format(new_record_file)
